                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                    ...
                    <div className="relative rounded-2xl p-8 flex flex-col bg-card border border-primary/30 overflow-hidden">
                        ...
                        <button
                            ...
                            className="w-full py-3 rounded-xl bg-primary text-primary-foreground text-center text-sm hover:opacity-90 transition-opacity disabled:opacity-60"
                            style={{ color: "var(--background)" }}
                        >
                            {loadingUpgrade ? "Redirecting..." : user?.plan === "pro" ? "Current Plan" : "Upgrade to Pro"}
                        </button>
                    </div>
                </div>
            </div>
