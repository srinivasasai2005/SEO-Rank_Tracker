...
// Search Google for a keyword and extract raning results for a target domain
export async function rankTracker(keyword, targetDomain) {
    ...
    try {
        ...
        for(let getPage = 0; getPage < 5; getPage++) {
            await page.goto(`https://www.google.com/search?q=${encodeURIComponent(keyword)}&start=${getPage * 10}&num=10&hl=en&gl=us`, {waitUntil: 'networkidle'});
